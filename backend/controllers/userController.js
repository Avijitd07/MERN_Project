...
const catchAsyncErrors = require('../middleware/cacheAsyncErrors');
...
//Reset Password
exports.resetPassword = cacheAsyncErrors(async (req, res, next) => {
...
exports.updatePassword = catchAsyncErrors(async (req, res, next) => {
    ...
    if (req.body.newPassword !== req.body.confirmPassword) {
        return next(new ErrorHandler('Password does not matches with each other', 400));
    }
...
exports.updateUserRoll = catchAsyncErrors(async (req, res, next) => {
    const newUserData = {
        name: req.body.name,
        email: req.body.email,
        role: req.body.role
